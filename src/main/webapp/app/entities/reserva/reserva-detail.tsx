    ...
    <Row>
      <Col md="8">
        <h2 data-cy="reservaDetailsHeading">
          <Translate contentKey="fsijhipsterApp.reserva.detail.title">Reserva</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="fsijhipsterApp.reserva.vuelo">Vuelo</Translate>
          </dt>
          <dd>{reservaEntity.vuelo ? reservaEntity.vuelo.id : ''}</dd>
          <dt>
            <Translate contentKey="fsijhipsterApp.reserva.asiento">Asiento</Translate>
          </dt>
          <dd>{reservaEntity.asiento ? reservaEntity.asiento.id : ''}</dd>
          <dt>
            <Translate contentKey="fsijhipsterApp.reserva.pasajero">Pasajero</Translate>
          </dt>
