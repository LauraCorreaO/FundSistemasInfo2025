  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.reserva.home.createOrEditLabel" data-cy="ReservaCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.reserva.home.createOrEditLabel">Create or edit a Reserva</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.reserva.codigo')}
                id="reserva-codigo"
                name="codigo"
                data-cy="codigo"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.reserva.fechaReserva')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.reserva.estado')}
                id="reserva-estado"
                name="estado"
                data-cy="estado"
                type="text"
              ...
              <ValidatedField
                ...
                name="vuelo"
                data-cy="vuelo"
                label={translate('fsijhipsterApp.reserva.vuelo')}
                type="select"
              >
                <option value="" key="0" />
                {vuelos
              ...
              <ValidatedField
                ...
                name="asiento"
                data-cy="asiento"
                label={translate('fsijhipsterApp.reserva.asiento')}
                type="select"
              >
                <option value="" key="0" />
                {asientos
              ...
              <ValidatedField
                ...
                name="pasajero"
                data-cy="pasajero"
                label={translate('fsijhipsterApp.reserva.pasajero')}
                type="select"
              >
                <option value="" key="0" />
                {pasajeros
