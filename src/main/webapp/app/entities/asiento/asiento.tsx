  ...
  return (
    <div>
      <h2 id="asiento-heading" data-cy="AsientoHeading">
        <Translate contentKey="fsijhipsterApp.asiento.home.title">Asientos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="fsijhipsterApp.asiento.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/asiento/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="fsijhipsterApp.asiento.home.createLabel">Create new Asiento</Translate>
          </Link>
        </div>
      </h2>
        ...
        {asientoList && asientoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="fsijhipsterApp.asiento.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('numero')}>
                  <Translate contentKey="fsijhipsterApp.asiento.numero">Numero</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('numero')} />
                </th>
                <th className="hand" onClick={sort('clase')}>
                  <Translate contentKey="fsijhipsterApp.asiento.clase">Clase</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('clase')} />
                </th>
                <th className="hand" onClick={sort('disponible')}>
                  <Translate contentKey="fsijhipsterApp.asiento.disponible">Disponible</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="fsijhipsterApp.asiento.home.notFound">No Asientos found</Translate>
            </div>
          )
        )}
      </div>
