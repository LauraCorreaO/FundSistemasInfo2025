  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.vuelo.home.createOrEditLabel" data-cy="VueloCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.vuelo.home.createOrEditLabel">Create or edit a Vuelo</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.vuelo.numeroVuelo')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.vuelo.origen')}
                id="vuelo-origen"
                name="origen"
                data-cy="origen"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.vuelo.destino')}
                id="vuelo-destino"
                name="destino"
                data-cy="destino"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.vuelo.fechaSalida')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.vuelo.fechaLlegada')}
