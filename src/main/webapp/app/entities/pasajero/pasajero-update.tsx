  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.pasajero.home.createOrEditLabel" data-cy="PasajeroCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.pasajero.home.createOrEditLabel">Create or edit a Pasajero</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.pasajero.nombre')}
                id="pasajero-nombre"
                name="nombre"
                data-cy="nombre"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.pasajero.apellido')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.pasajero.email')}
                id="pasajero-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.pasajero.telefono')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.pasajero.fechaNacimiento')}
